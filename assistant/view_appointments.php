...
$sql = "SELECT tbl_patient.*, tbl_service.service_name, CONCAT(tbl_dentist.first_name, ' ', tbl_dentist.last_name) AS dentist_name
        FROM tbl_patient
        JOIN tbl_service ON tbl_patient.service_req = tbl_service.id
        JOIN tbl_dentist ON tbl_patient.booked_dentist = tbl_dentist.id
        ORDER BY tbl_patient.ap_date, tbl_patient.ap_time";
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="/DACclinic/assistant/view_appointments.php" class="active"><span class="las la-user-circle"></span>
        ...
        if(mysqli_num_rows($result) == 0) {
            ...
            while($row=mysqli_fetch_array($result)) {
                ...
                <tr> 
                    ...
                    <td>$comment</td>
                    <td>
                    <a class='btn btn-primary' data-bs-toggle='modal' data-bs-target='#staticBackdrop' onclick='setDeleteUserId3($id)'>Archive</a>
                </td>
