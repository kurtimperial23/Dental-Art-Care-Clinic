        ...
        <div class="main-content">
            <header>
                    ...
                    <div class="user-wrapper">
                        ...
                        <div>
                        <h2>Edit Dentist Services</h2>
                        </div>
                    </div>
            </header>
<main>
        <div class="container">
            <form action="/DACclinic/processes/edit_service_process.php" method="post">
                <h1>Edit Services </h1>
                <div class="row">
                    <input type="hidden" name="txtid" value="<?php echo $id;?>">
                    <div class="col"><label for="txtservicename">Edit Service Name:</label></div>
                    <div class="col"><label for="txtservicetype">Edit Type:</label></div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col"><label for="txtdoctor">Price:</label></div>
                </div>
