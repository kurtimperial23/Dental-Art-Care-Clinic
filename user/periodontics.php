...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/DACclinic/css/services_sub.css">
        <link
            rel="stylesheet"
    ...
    <body>
        ...
        <main>
                <div class="container">
                    <div class="row">
                        <div class="col-3">
                            <img src="/DACclinic/images/1.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="col-3">
                            <h3>Gingivectomy and gingivoplasty through electrocautery</h3>
